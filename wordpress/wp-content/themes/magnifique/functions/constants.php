...
if(!defined('CI_THEME_NAME')) 		define('CI_THEME_NAME', 'magnifique');
...
if(!defined('CI_THEME_NICENAME')) 	define('CI_THEME_NICENAME', 'Magnifique'); 
...
if(!defined('CI_DOCS'))				define('CI_DOCS', 'http://www.cssigniter.com/ignite/magnifique-documentation/');
