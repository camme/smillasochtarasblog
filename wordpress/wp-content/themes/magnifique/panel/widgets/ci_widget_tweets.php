...
class CI_Tweets extends WP_Widget {
	...
	function form($instance){
		...
		else
		{
			...
			echo '<p><label for="' . $this->get_field_id('ci_title') . '">' . __('Title:', 'ci_theme') . '</label><input id="' . $this->get_field_id('ci_title') . '" name="' . $this->get_field_name('ci_title') . '" type="text" value="' . esc_attr($ci_title) . '" class="widefat" /></p>';
			echo '<p><label for="' . $this->get_field_id('ci_username') . '">' . __('Username:', 'ci_theme') . '</label><input id="' . $this->get_field_id('ci_username') . '" name="' . $this->get_field_name('ci_username') . '" type="text" value="' . esc_attr($ci_username) . '" class="widefat" /></p>';
			echo '<p><label for="' . $this->get_field_id('ci_number') . '">' . __('Number of tweets:', 'ci_theme') . '</label><input id="' . $this->get_field_id('ci_number') . '" name="' . $this->get_field_name('ci_number') . '" type="text" value="' . esc_attr($ci_number) . '" class="widefat" /></p>';
		}
